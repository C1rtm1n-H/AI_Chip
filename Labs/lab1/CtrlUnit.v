...
module CtrlUnit(
    ...
    // [Topic 1]: Please add SAMV-related decoding functions here. 
    // You may add new signals. 
    ...
    wire SAMV = SAMVop & funct3_0 & funct7_0; // <--
    ...
    assign dataToReg = {2{L_valid}}                         & 2'b00 |
                       {2{SAMV}}                            & 2'b01 |
                       {2{R_valid | I_valid | LUI | AUIPC}} & 2'b10 |
                       {2{JAL | JALR}}                      & 2'b10 ;

    assign regWrite = R_valid | I_valid | L_valid | LUI | AUIPC | JAL | JALR | SAMV; // Complete the signal here.
